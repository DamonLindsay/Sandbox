...
def calculate_e(n):
    ...
    Args:
        n (int): The number of decimal places to calculate e to.

    Returns:
        decimal.Decimal: The calculated value of e to the specified number of decimal places.
    """
    decimal.getcontext().prec = n + 2  # Set precision to n+2 to ensure accuracy
...
def main():
    ...
    rounded_e = round(calculated_e, digits)  # Round to the specified number of decimal places
